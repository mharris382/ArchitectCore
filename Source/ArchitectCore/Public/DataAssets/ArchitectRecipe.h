...
struct FArchitectCornerAsset
{
    ...
    TEnumAsByte<ECornerSpawnMode> CornerMode;

 

    UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (EditCondition = "!UseRecipes && CornerMode==ECornerSpawnMode::EdgeCorner || CornerMode==ECornerSpawnMode::FullCorner", EditConditionHides))
    FArchitectAsset Corner;

    UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (EditCondition = "!UseRecipes && CornerMode==ECornerSpawnMode::SplitCorner", EditConditionHides))
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (EditCondition = "!UseRecipes && CornerMode!=ECornerSpawnMode::NoCorner && CornerMode!=ECornerSpawnMode::EdgeCorner", EditConditionHides))
    bool OverrideRecipeFootprint;

    UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (EditCondition = "!UseRecipes && CornerMode!=ECornerSpawnMode::NoCorner && CornerMode!=ECornerSpawnMode::EdgeCorner && OverrideRecipeFootprint", EditConditionHides))
